    ...
    return (
        <div className="min-h-screen bg-gray-50 flex flex-col">
            <div className={`w-full p-6 flex flex-col items-center ${
                ...
                <p className="text-gray-500 text-sm mt-1 text-center">Selamat datang kembali!</p>
            </div>
            ...
            <div className="flex items-center justify-between text-sm">
                ...
                <Link href="/forgot-password" className="text-purple-500 font-semibold">
                    Lupa password?
                </Link>
            </div>
            ...
            <div className="flex-shrink-0 ml-2">
                <Link href={`/register?type=${activeTab}`} className="text-purple-500 font-bold text-sm">
                    Belum punya akun?
                </Link>
            </div>
        </form>
