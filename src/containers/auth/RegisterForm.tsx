...
import { User, Lock, Mail, Phone, ArrowLeft, GraduationCap, BookOpen } from 'lucide-react';
                ...
                <form id="registerForm" onSubmit={handleSubmit(onSubmit)} className="space-y-5">
                    <div>
                        <InputField
                            ...
                            label="Nama Lengkap"
                            placeholder={activeTab === 'student' ? 'Masukkan nama kamu' : 'Masukkan nama Tutor'}
                            {...register('fullName')}
                        />
                    ...
                    <div className="flex items-start gap-3 px-1">
                        ...
                        <label className="text-sm text-gray-600 leading-relaxed">
                            ...
                            <button type="button" className="text-purple-600 font-medium">Syarat dan Ketentuan</button>{' '}
                            serta{' '}
                            <button type="button" className="text-purple-600 font-medium">Kebijakan Privasi</button>
                        </label>
                    </div>
                    ...
                    <p className="text-center text-gray-500 text-sm mt-3">
                        Sudah punya akun?{' '}
                        <Link href="/" className="text-purple-500 font-bold">Masuk</Link>
                    </p>
                </form>
            </main>
