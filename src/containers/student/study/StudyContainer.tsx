...
import { Clock, Video, CheckCircle, PlayCircle, Calendar, Award, BookOpen, TrendingUp } from 'lucide-react';
            ...
            <div className="px-6 -mt-8">
                ...
                <div className="mb-6">
                    <div className="flex items-center justify-between mb-3">
                        <h2 className="text-lg font-bold text-gray-800">Jadwal Mendatang</h2>
                        <button className="text-emerald-600 text-sm font-medium">Lihat Semua</button>
                    </div>
                    <div className="space-y-3">
                        {upcomingSchedule.map(schedule => (
                            <div key={schedule.id} className="bg-white rounded-xl shadow-lg p-4">
                                <div className="flex items-center gap-4">
                                    ...
                                    <div className="flex-1">
                                        <h3 className="font-bold text-gray-800 mb-1">{schedule.title}</h3>
                                        <p className="text-sm text-gray-600 mb-2">{schedule.teacher}</p>
                                    ...
                                    <div className="flex-1">
                                        <div className="flex items-start justify-between mb-1">
                                            <div>
                                                ...
                                                <p className="text-emerald-600 text-sm">{course.teacher}</p>
                                            </div>
                        ...
                        {course.category}
                                ...
                                <div className="mb-4">
                                    ...
                                    <p className="text-xs text-gray-500 mt-1">
                                        {course.completedSessions} dari {course.totalSessions} sesi selesai
                                    </p>
                                </div>
                                ...
                                {course.status === 'active' && (
                                    <div className="flex items-center justify-between pt-4 border-t border-gray-100">
                                        <div className="flex items-center text-sm text-gray-600">
                                            ...
                                            <span className="text-xs">Sesi berikutnya: {course.nextSession}</span>
                                        </div>
