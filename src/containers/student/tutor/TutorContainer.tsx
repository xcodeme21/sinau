...
import { Search, Filter, MapPin, Star, Clock, Play, DollarSign, Award, Calendar } from 'lucide-react';
            ...
            <div className="px-6 -mt-12">
                ...
                <div className="flex items-center justify-between mb-4">
                    <p className="text-gray-600 text-sm">
                        Ditemukan <span className="font-bold text-emerald-600">{filteredTeachers.length}</span> guru
                    </p>
                    <select
                        value={sortBy}
                ...
                <div className="space-y-4">
                    {filteredTeachers.map(teacher => (
                        <div key={teacher.id} className="bg-white rounded-2xl shadow-lg overflow-hidden hover:shadow-xl transition">
                            <div className="p-5">
                          ...
                          Verified
                                        ...
                                        <div className="flex items-center gap-3 mb-2">
                                            ...
                                            <span className="text-xs text-gray-600">{teacher.students} siswa</span>
                                        </div>
                                        <p className="text-xs text-gray-600 leading-relaxed line-clamp-2">{teacher.bio}</p>
                                    </div>
                                </div>
